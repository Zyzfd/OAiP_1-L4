// L4_4 Kalyshev.cpp : Определяет точку входа для приложения.
//

#include "framework.h"
#include "L4_4 Kalyshev.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_L44KALYSHEV, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_L44KALYSHEV));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_L44KALYSHEV));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_L44KALYSHEV);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        RecursiveImage4_2(hdc, 500, 200, 100);
        RecursiveImage4_3(hdc, 800, 200, 100);
        RecursiveImage4_4(hdc, 200, 650, 100);
        RecursiveImage4_5(hdc, 600, 650, 100);
        RecursiveImage4_6(hdc, 1000, 650, 100);
        RecursiveImage4_7(hdc, 1400, 650, 100);
