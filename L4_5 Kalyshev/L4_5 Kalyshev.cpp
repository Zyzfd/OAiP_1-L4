// L4_5 Kalyshev.cpp : Определяет точку входа для приложения.
//

#include "framework.h"
#include "L4_5 Kalyshev.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_L45KALYSHEV, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_L45KALYSHEV));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_L45KALYSHEV));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_L45KALYSHEV);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        RecursiveImage5_2(hdc, 600, 200, 100);
        RecursiveImage6_1(hdc, 900, 200, 100);
        RecursiveImage6_2(hdc, 1200, 200, 100);
        RecursiveImage7_1(hdc, 200, 550, 100);
        RecursiveImage7_2(hdc, 500, 550, 100);
        EndPaint(hWnd, &ps);
    }
    break;
    case WM_DESTROY:
