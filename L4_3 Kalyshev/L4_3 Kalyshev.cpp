// L4_3 Kalyshev.cpp : Определяет точку входа для приложения.
//

#include "framework.h"
#include "L4_3 Kalyshev.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_L43KALYSHEV, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_L43KALYSHEV));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_L43KALYSHEV));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_L43KALYSHEV);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        RecursiveImage3_3(hdc, 1000, 200, 100);
        RecursiveImage3_4(hdc, 1400, 200, 100);
        RecursiveImage3_5(hdc, 200, 600, 100);
        RecursiveImage3_6(hdc, 600, 600, 100);
        RecursiveImage3_7(hdc, 1000, 600, 100);
        RecursiveImage3_8(hdc, 1400, 600, 100);
