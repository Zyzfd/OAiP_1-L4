// L4_2 Kalyshev.cpp : Определяет точку входа для приложения.
//

#include "framework.h"
#include "L4_2 Kalyshev.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_L42KALYSHEV, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_L42KALYSHEV));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_L42KALYSHEV));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_L42KALYSHEV);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        RecursiveImage2_2(hdc, 450, 200, 100);
        RecursiveImage2_3(hdc, 800, 200, 100);
        RecursiveImage2_4(hdc, 1200, 200, 100);
        RecursiveImage2_5(hdc, 200, 550, 100);
        RecursiveImage2_6(hdc, 450, 550, 100);
        RecursiveImage2_7(hdc, 900, 550, 100);
